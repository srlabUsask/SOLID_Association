...
Stratification design:
    1. Methods with fewer than three lines of code are dropped by default.
       Empty-bodied methods and one-line accessors produce uniform
       Compliant LLM scores and would inflate agreement metrics without
       exercising the rubric on substantive cases. Use --no-loc-floor to
       retain them.
